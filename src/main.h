...
extern pthread_mutex_t modevent_mutex;
extern pthread_mutex_t system_mutex;
extern pthread_mutex_t stream_mutex;
extern pthread_mutex_t widget_mutex;
...
extern pthread_mutex_t dyspcont_mutex;

extern TX_EVENTER modevent_evnt;
extern TX_EVENTER strmevent_evnt;
extern TX_EVENTER main_thread_evnt;

//char cMediaFileName[256];
//char cMediaFileNameSlow[256];	
extern int iSystemListCnt;
extern SYSTEM_INFO *miSystemList;

extern int iModuleEventCnt;
extern MODULE_EVENT *meModuleEventList;

extern unsigned int iSoundListCnt;
extern SYS_SOUND_TYPE *mSoundList;

extern int iModuleCnt;
extern MODULE_INFO *miModuleList;

extern int iRectangleCnt;
extern RECT_INFO *riRectangleList;

extern int iCurrentWebMenuPage;
extern MENU_PAGE *pWebMenu;

extern int iAlarmClocksCnt;
extern ALARM_CLOCK_TYPE *actAlarmClockInfo;

extern int iMailCnt;
extern MAIL_INFO *miMailList;

extern int iActionManualCnt;
extern ACTION_MANUAL_INFO * amiActionManual;

extern int iStreamTypeCnt;
extern STREAM_TYPE *stStreamType;

extern int iInternetRadioCnt;
extern STREAM_SETT *irInternetRadio;

extern int iRadioStationsCnt;
extern RADIO_INFO *riRadioStation;
...
extern SECURITY_KEY_INFO *cAlienKeyList;

extern int iPtzSettingsListCnt;
extern PTZ_SET_INFO *psiPtzSettingsList;
extern PTZ_SET_INFO psiPtzHomeSettings;

extern int iSkipEventMaxCnt;
extern int iSkipEventListCnt;
extern MODULE_EVENT *cSkipEventList;
extern unsigned int uiSkipEventListFilter;
extern unsigned int uiSkipEventNumberFilter;

extern int iDirsCnt;
extern DIRECTORY_INFO *diDirList;

extern int iActionCnt;
extern ACTION_INFO *maActionInfo;	

extern int iSecurityKeyCnt;
extern SECURITY_KEY_INFO *skiSecurityKeys;

extern SECURITY_KEY_INFO skiUpdateKeyInfo;
extern int iUpdateKeyInfoAction;
extern int iUpdateKeyInfoResult;
...
extern unsigned int 	iStreamCnt;
extern STREAM_INFO 	**SyncStream;

extern int 					iDisplayContentCurrent;
extern unsigned int 			iDisplayContentCnt1;
extern unsigned int 			iDisplayContentCnt2;
extern unsigned int 			iDisplayContentLiveTime;
extern DISPLAY_CONTENT_INFO 	*dciDisplayContent1;
extern DISPLAY_CONTENT_INFO 	*dciDisplayContent2;

extern misc_buffer mbManual;

extern unsigned int uiMaxFileCopyTimeBreakValue;
extern unsigned int uiMaxFileCopyTimeMessageValue;

extern char cThreadMainStatus;
extern char cThreadScanerStatus;
extern unsigned int cThreadFingerStatus;
extern char cThreadFingerRun;
extern char cThreadScanerStatusUsbio;
extern unsigned int uiThreadCopyStatus;
extern unsigned int iStreamTimeMaxSet;
extern unsigned int iCameraTimeMaxSet;
extern char OnvifAuth;
extern char RtspAuth;
extern char WebAuth;
extern unsigned int WebMaxTimeIdle;
extern int iCurrentShowRectangle;
extern char cCameraRectFile[256];
extern char cCameraShotFile[256];
extern char cCameraSensorFile[256];
extern char cNextYouTubeURL[4096];
extern char cAlarmFile[256];
extern char cModuleFile[256];
extern char cSoundFile[256];
extern char cMailFile[256];
extern char cStreamTypeFile[256];
extern char cStreamFile[256];
...
extern char cCamRectangleFile[256];
extern char cUserFile[256];
extern char cManualFile[256];
extern char cConfigFile[256];
extern char cRadioFile[256];
extern unsigned char iRadioVolume;
extern unsigned int uiPaddingSize;
extern unsigned int uiTextColor;
extern float fMenuSize;
extern unsigned char ucBroadCastTCP;
//char cClearStatusesFiles;
//char cClearEventsFiles;
//char cClearActionsFiles;
extern char cCaptureFilesView;
extern char cBackUpFilesView;
extern char cCaptureFilesLevel;
extern char cBackUpFilesLevel;
extern char cCaptureFilesViewDef;
extern unsigned int uiMediaSlowSettings;
extern unsigned int uiMediaSlowFramesSkip;

extern char cFileLocation[256];
extern char cCurrentFileLocation[256];
extern char cFileAlarmLocation[256];
extern char cMailAddress[64];
extern char cMailServer[64];
extern char cMailLogin[64];
extern char cMailPassword[64];
extern char cMailAuth[64];
extern char cExternalApp[256];
extern char cNTPServer[64];
extern char cUdpTargetAddress[64];
extern char cNewSourcePath[256];
extern char cNewSourceFile[256];
extern char cNewSourceLogin[256];
extern char cNewSourcePass[256];
extern char cRebootAfterUpdate;

extern unsigned int uiDeviceType;
extern unsigned int uiOnvifStream;
extern unsigned int uiRTSPStream;
extern unsigned int uiRTSPForceAudio;
extern unsigned int uiOnvifPort;
extern unsigned int uiRTSPPort;
extern unsigned int uiRTPClntVidPort;
extern unsigned int uiRTPClntAudPort;
extern unsigned int uiRTPServVidPort;
extern unsigned int uiRTPServAudPort;	
extern unsigned int uiWebPort;
extern unsigned int uiErrorCameraRestart;
extern unsigned int uiErrorCameraRestartWait;
extern unsigned int uiErrorAudioRestart;
extern unsigned int uiErrorAudioRestartWait;
extern unsigned int uiErrorVideoRestart;
extern unsigned int uiErrorVideoRestartWait;
extern int iTimeCor;
extern int VSync;
extern unsigned int uiShowerLiveCtrlTime;
extern unsigned int uiShowMode;
extern unsigned int uiShowModeCur;
extern unsigned int uiTimeSndPwrOff;
extern int iIntervalRescanCard;

extern unsigned char ucCaptEnabledVideo;
extern unsigned char ucCaptEnabledAudio;
extern unsigned char ucCaptEnabledStatuses;
extern unsigned char ucCaptEnabledEvents;
extern unsigned char ucCaptEnabledActions;

extern int cFileWriterService;
extern char cWriterServicePath[MAX_PATH];


extern int iSlideShowTimerSet;
extern int iSlideShowOnTime;
extern int iSlideShowOffTime;
extern int iBasicVolume;
extern int iAlarmVolume;
extern char cSettRandomFile, cSettRandomDir, cCurRandomFile, cCurRandomDir;
extern char cZoom;
extern char cDateTimeReference;
extern char cAccelerateTextRender;
extern unsigned int uiStartMode;
extern unsigned int uiTerminalMenuID;
extern unsigned int uiMenuWidth;
extern unsigned int uiMenuHeight;
extern unsigned int uiDefAlarmSound;
extern unsigned int uiDefAlarmRepeats;
extern unsigned int uiWEBServer;
extern unsigned int cCurShowType;
extern MAIL_INFO cLogMlList;

extern unsigned int uiMediaIoTimeout;

extern char cSysStatus[64];
extern unsigned int uiSoundMessageID;
extern int64_t iSoundMessageTimer;
extern unsigned int uiSoundMessagePauseSize;
extern unsigned int uiSoundMessageVolume;

extern unsigned int uiFlvBufferSize;

extern int iListFilesCurPos;
extern int iListFilesCount;
extern int iListDirsCurPos;
extern int iListDirsCount;
extern char cSettShowDirNameText[128];
	
extern char cCurrentPlayType[32];
extern char cCurrentPlayName[256];
extern char cCurrentPlayDir[256];
extern LIST_FILES_TYPE *cListFiles;
extern LIST_FILES_TYPE	*cListDirs;

extern char cDisplayMessageText[128];
extern char cDisplayMessageChanged;
extern char cEventMessageText[128];
extern char cEventMessageChanged;

extern char cStartTime[64];
