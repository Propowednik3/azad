...
#define     MI_TIMEOUT            3         // General error
...
int MFRC522_commandTag(int iPort, uint8_t command, uint8_t *data, int dlen, uint8_t *result, int *rlen);
int MFRC522_requestTag(int iPort, uint8_t mode, uint8_t *type);
...
int MFRC522_readFromTag(int iPort, uint8_t blockAddr, uint8_t *recvData);
int MFRC522_writeToTag(int iPort, uint8_t blockAddr, uint8_t *writeData);
