...
void * Writer(void *pData)
{
	...
	unsigned int uiEvent, ret, iLoop;
		...
		if (ret != 0)
		{
			...
			if (iChannel == 0) 
			{
				...
				if (uiEvent == WRT_EVENT_COPY_FILE_GET_ORDER)
				{
					...
					{
						case WRT_TYPE_ARCHIVE_FULL: strcpy(cCurrPath, cLocalArchivePathFull); break;
						case WRT_TYPE_ARCHIVE_SLOW: strcpy(cCurrPath, cLocalArchivePathSlow); break;
						case WRT_TYPE_ARCHIVE_DIFF: strcpy(cCurrPath, cLocalArchivePathDiff); break;
						case WRT_TYPE_ARCHIVE_AUDIO: strcpy(cCurrPath, cLocalArchivePathAudio); break;
						case WRT_TYPE_ARCHIVE_STATUSES: strcpy(cCurrPath, cLocalArchivePathStatuses); break;
						case WRT_TYPE_ARCHIVE_EVENTS: strcpy(cCurrPath, cLocalArchivePathEvents); break;
						case WRT_TYPE_ARCHIVE_ACTIONS: strcpy(cCurrPath, cLocalArchivePathActions); break;
						case WRT_TYPE_BACKUP_FULL: strcpy(cCurrPath, cLocalBackUpPathFull); break;
						case WRT_TYPE_BACKUP_SLOW: strcpy(cCurrPath, cLocalBackUpPathSlow); break;
						case WRT_TYPE_BACKUP_DIFF: strcpy(cCurrPath, cLocalBackUpPathDiff); break;
						case WRT_TYPE_BACKUP_AUDIO: strcpy(cCurrPath, cLocalBackUpPathAudio); break;
						case WRT_TYPE_BACKUP_STATUSES: strcpy(cCurrPath, cLocalBackUpPathStatuses); break;
						case WRT_TYPE_BACKUP_EVENTS: strcpy(cCurrPath, cLocalBackUpPathEvents); break;
						case WRT_TYPE_BACKUP_ACTIONS: strcpy(cCurrPath, cLocalBackUpPathActions); break;
						default: strcpy(cCurrPath, cMainPath); break;
					}
					DBG_MUTEX_UNLOCK(&system_mutex);					
